...
from app.utils.migrate_db import migrate_chat_messages_table, migrate_client_deal_status_fields, migrate_client_payment_fields, migrate_link_utm_fields, migrate_notification_target_partner, migrate_partner_approval_fields, migrate_partner_b24_fields, migrate_partner_payment_details, migrate_partner_reward_percentage, migrate_partner_role_field, migrate_payment_request_details
