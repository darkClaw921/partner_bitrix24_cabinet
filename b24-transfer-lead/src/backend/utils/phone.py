...
def normalize_phone(phone: str) -> str:
    """Нормализация телефонного номера в формат 79308312222 (без +)
    ...
    Returns:
        Нормализованный номер без префикса + (например, "79308312222")
    """
    phone = str(phone)
...
def format_phone_variants(phone: str) -> list[str]:
    ...
    Args:
        phone: телефон в любом формате (уже нормализованный)
    ...
    """
    # phone уже должен быть нормализованным (79308312222 без +)
    normalized = phone
